  ...
  return (
    <div className={wrapperClasses}>
      ...
      >
        <g>
          <path
            className="zoom-in-g [transition-duration:1500ms] [transition-delay:100ms] hover:scale-95"
            d="M 6,2 H 2 V 3 H 1 V 10 H 2 V 11 H 6 V 6 H 4 v 2 h 1 v 1 H 3 V 4 H 4 v 1 h 2 z"
            id="path510"
          />
          <path
            className="zoom-in-l [transition-duration:1500ms] [transition-delay:100ms] hover:scale-95"
            d="M 10,14 H 7 l -1e-7,-10 H 9 l 10e-8,8 H 10 Z"
            id="path512"
          />
          <path
            className="zoom-in-d [transition-duration:1500ms] [transition-delay:100ms] hover:scale-95"
            id="path514"
