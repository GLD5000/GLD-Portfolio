...
export default function About() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-t  from-secondary-light via-bg-var to-bg-var py-20 dark:bg-gradient-to-t dark:from-secondary dark:via-bg-var-dk dark:to-bg-var-dk">
