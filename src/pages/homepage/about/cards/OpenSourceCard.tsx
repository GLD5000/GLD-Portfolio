    ...
    <>
      <AboutCard
        ...
        cta={
          <a
            href="#contact"
            className="m-auto h-fit w-60 rounded-full border-2 border-black bg-primary px-4 py-3 text-center text-xl text-white hover:bg-white hover:text-black hover:transition focus:bg-white focus:text-black focus:transition"
            // onClick={() => {
