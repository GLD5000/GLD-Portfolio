...
export default function Hero({
  ...
  return (
    <>
      <div className=" absolute top-0  z-[997] grid h-screen w-full bg-secondary-light dark:bg-secondary lg:min-h-body max-lg:landscape:h-[100vmax]">
        <Stars />
      </div>
      <div
        id="hero"
        ref={elementRef}
        className=" absolute top-0  z-[997] grid h-screen w-screen lg:min-h-body max-lg:landscape:h-[100vmax] "
      >
